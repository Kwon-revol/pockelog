  ...
  return (
    <div className="space-y-7">
      ...
      <form action="/ledger" className="grid grid-cols-1 gap-3 rounded-3xl border border-slate-200/80 bg-white p-4 shadow-sm md:grid-cols-2 lg:grid-cols-7" method="get">
        <label className="block min-w-0 text-xs font-bold text-slate-500 lg:col-span-1">시작일<input className="mt-1.5 block w-0 min-w-full max-w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm" defaultValue={initialData.filters.startOn} name="start" type="date" /></label>
        <label className="block min-w-0 text-xs font-bold text-slate-500 lg:col-span-1">종료일<input className="mt-1.5 block w-0 min-w-full max-w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm" defaultValue={initialData.filters.endOn} name="end" type="date" /></label>
